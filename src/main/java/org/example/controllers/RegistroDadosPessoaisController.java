...
public class RegistroDadosPessoaisController implements Initializable {
    ...
    void btnRegistrarSeguinteDD(ActionEvent event) {
        ...
        } else if (this.verificacoes.verficaInteiro(verificaNumCC, txtFdRegistroNccId.getText()) == 0) {
        ...
        } else if (this.verificacoes.verficaInteiro(verificaNIF, txtFdRegistroNIFD.getText()) == 0) {
        ...
        } else if (this.verificacoes.verficaInteiro(verificaContacto, txtFdRegistroContactoId.getText()) == 0) {
